...
?>
<script>
	Phx.vista.ConsultaOpPlanPago= Ext.extend(Phx.frmInterfaz, {
		...
		},
		{
			config:{
	        	...
	        	data :	[
	        	        ...
	        	        ['consulta_op_plan_pago','Consulta OP por plan de pagos'],
	        	        ['obli_pag_pend','Obligaciones de pagos pendientes'],
		...
		constructor : function(config) {
			Phx.vista.ConsultaOpPlanPago.superclass.constructor.call(this, config);
			this.init();
		...
		iniciarEventos:function(){        
           ...
           this.Cmp.id_gestion.on('select',function(c,r,n){
           	    //console.log('ver gestion ',c);
				this.Cmp.gestion.setValue(c.lastSelectionText);
			},this);
	...
	ActSave:'../../sis_tesoreria/control/PlanPago/consultaOpPlanPago',
