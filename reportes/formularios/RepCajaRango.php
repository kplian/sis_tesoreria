...
?>
<script>
	Phx.vista.RepCajaRango = Ext.extend(Phx.frmInterfaz, {
	Atributos : [
		{
			config: {
				name: 'id_caja',
	...
	ActSave : '../../sis_tesoreria/control/Caja/repCajaFechas',
	timeout : 1500000,
	...
	constructor : function(config) {
		Phx.vista.RepCajaRango.superclass.constructor.call(this, config);
		this.init();			
		this.iniciarEventos();
	},
	...
	onSubmit:function(o){			
		...
		Phx.CP.loadingShow();		
		Ext.Ajax.request({
			url:'../../sis_tesoreria/control/Caja/repCajaFechas',
			params:
			{	
				'id_caja' : idcaja,
				'fecha_ini' : ini,
