...
require_once dirname(__FILE__).'/../../pxp/pxpReport/Report.php';
 ...
 class CustomReport extends MYPDF {
    ...
    public function Header() {
        ...
        $this->SetFontSize(16);
        $this->SetFont('','B'); 
        $this->Cell(145, $height, 'Evolución Presupuestaria', 0, 0, 'C', false, '', 1, false, 'T', 'C');        
...
Class RComEjePag extends Report {
    ...
    function writeDetalles (DataSource $dataSource, TCPDF $pdf,$tipo) {
        ...
        $pdf->tablewidths=array($width2,$width2,$width3,$width1,$width1,$width1);
        $pdf->tablealigns=array('L','L','L','R','R','R');
        $pdf->tablenumbers=array(0,0,0,1,1,1);
