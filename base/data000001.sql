...
/***********************************I-DAT-MMV-TES-ETR-3127-03/03/2021*****************************************/
select pxp.f_insert_tgui ('Reporte VoBo Cbte', 'Reporte para VoBo Cbte (Finanzas)', 'CCE', 'si', 13, 'sis_tesoreria/vista/consulta_contables/ConsultaContables.php', 3, '', 'ConsultaContables', 'TES');
/***********************************F-DAT-MMV-TES-ETR-3127-03/03/2021*****************************************/
