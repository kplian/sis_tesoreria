CREATE OR REPLACE FUNCTION tes.f_lista_depto_tesoreria_wf_sel (
...
BEGIN
  v_nombre_funcion ='tes.f_lista_depto_tesoreria_wf_sel';
    ...
    if (v_codigo_subsistema = 'ADQ') then
      ...
      where cd.id_cotizacion = v_id_tabla 
      and cd.estado_reg = 'activo' and cd.cantidad_adju > 0;
      
    elsif(v_codigo_subsistema = 'PLANI') then
