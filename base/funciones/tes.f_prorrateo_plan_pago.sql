...
#MDT-3      01/04/2021   EGS            Se inactiva los prorrateos existentes del plan de pagos y al modificar el mismo.
*/
DECLARE
    v_registros record;
...
BEGIN
    ...
    IF (p_id_plan_pago_fk is NULL  or v_registros_plan_pago.tipo = 'ant_aplicado' ) THEN
        ...
        IF p_pago_variable = 'no' THEN
            ...
            --#MDT-3 Borramos los prorrateos existentes y volvemos a generar
            DELETE from tes.tprorrateo Where id_plan_pago =p_id_plan_pago;
