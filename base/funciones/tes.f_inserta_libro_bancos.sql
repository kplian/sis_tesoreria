create function f_inserta_libro_bancos(p_administrador integer, p_id_usuario integer, p_hstore hstore) returns character varying
    language plpgsql
as
$$
/**************************************************************************
    ...
    IF(p_hstore ? 'fecha' = false)THEN
        ...
        insert into tes.tts_libro_bancos(
            ...
            id_casa_oracion
                    ...
                    (p_hstore->'id_casa_oracion')::integer
...
alter function f_inserta_libro_bancos(integer, integer, hstore) owner to postgres;
