CREATE OR REPLACE FUNCTION tes.f_consolidar_cheques (
...
BEGIN
  ...
  t.tipo,sum(t.importe_cheque) as importe_cheque into v_datos_cheques
  from tes.tts_libro_bancos t
  where t.sistema_origen='KERP' and t.comprobante_sigma=p_c31
  and t.tipo='cheque'
  ...
  v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
                    ...
                    array[' 0 = 0 ','','','','','NULL','NULL',v_datos_cheques.id_cuenta_bancaria::varchar,v_datos_cheques.id_depto::varchar,v_datos_cheques.a_favor::varchar,'NULL','0','',v_datos_cheques.detalle::varchar,v_datos_cheques.origen::varchar,p_tramites::varchar,v_datos_cheques.importe_cheque::varchar,'NULL','',v_datos_cheques.comprobante_sigma::varchar,'cheque',v_datos_cheques.id_finalidad::varchar,''::varchar],
