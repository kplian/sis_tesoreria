...
BEGIN
    ...
    if p_origen  = 'endesis' then
        ...
        raise notice '%,%,%',v_datos_deposito_cheque.id_depto, v_datos_deposito_cheque.beneficiario, v_datos_deposito_cheque.momento_pagado;
        raise notice '%,%,%',v_datos_deposito_cheque.manual, v_datos_deposito_cheque.nro_tramite, v_datos_deposito_cheque.id_depto_libro;
        raise notice '%,%,%',v_datos_deposito_cheque.glosa, v_datos_deposito_cheque.importe_haber,v_datos_deposito_cheque.id_cuenta_bancaria; 
		raise notice '%,%,%',v_datos_deposito_cheque.nro_cheque, v_datos_deposito_cheque.nombre_cheque_trans, v_datos_deposito_cheque.forma_pago;
        raise notice '%, %', v_datos_deposito_cheque.origen, v_datos_deposito_cheque.id_libro_bancos_deposito;
        ...
        IF(v_datos_deposito_cheque.id_libro_bancos_deposito is null)THEN
        v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
                    ...
                    array[' 0 = 0 ','','','','','NULL','NULL',v_datos_deposito_cheque.id_cuenta_bancaria::varchar,v_datos_deposito_cheque.id_depto_libro::varchar,v_datos_deposito_cheque.beneficiario::varchar,'NULL','0','','PAGO A '||v_datos_deposito_cheque.glosa::varchar,v_datos_deposito_cheque.origen::varchar,v_datos_deposito_cheque.nro_tramite::varchar,v_datos_deposito_cheque.importe_haber::varchar,'NULL','','C31-'||p_c31,'cheque',p_id_finalidad::varchar,'KERP',''||p_id_int_comprobante::varchar||''],
        ...
        v_resp = pxp.f_intermediario_ime(p_id_usuario::int4,NULL,NULL::varchar,'v58gc566o75102428i2usu08i4',13313,'172.17.45.202','99:99:99:99:99:99','tes.ft_ts_libro_bancos_ime','TES_LBAN_INS',NULL,'no',NULL,
        			array['filtro','ordenacion','dir_ordenacion','puntero','cantidad','_id_usuario_ai','_nombre_usuario_ai','id_cuenta_bancaria','id_depto','a_favor','nro_cheque','importe_deposito','nro_liquidacion','detalle','origen','observaciones','importe_cheque','id_libro_bancos_fk','nro_comprobante','comprobante_sigma','tipo','id_finalidad','sistema_origen','id_int_comprobante'],
                    array[' 0 = 0 ','','','','','NULL','NULL',v_datos_deposito_cheque.id_cuenta_bancaria::varchar,v_datos_deposito_cheque.id_depto_libro::varchar,v_datos_deposito_cheque.beneficiario::varchar,'NULL','0','','PAGO A '||v_datos_deposito_cheque.glosa::varchar,v_datos_deposito_cheque.origen::varchar,v_datos_deposito_cheque.nro_tramite::varchar,v_datos_deposito_cheque.importe_haber::varchar,v_datos_deposito_cheque.id_libro_bancos_deposito::varchar,'','C31-'||p_c31,'cheque',p_id_finalidad::varchar,'KERP',''||p_id_int_comprobante::varchar||''],
                    array['varchar','varchar','varchar','integer','integer','int4','varchar','int4','int4','varchar','int4','numeric','varchar','text','varchar','text','numeric','int4','varchar','varchar','varchar','int4','varchar','varchar']
                    ,'',NULL,NULL);
        END IF;
