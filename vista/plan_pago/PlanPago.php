...
<script>
    Phx.vista.PlanPago=Ext.extend(Phx.gridInterfaz,{
        ...
        liquido_base:0,//#MSA-31 liquido_base que no se debe sobrepasar en una cuota de pago
        desc_anticipo_base:0, //#MSA-31
        monto_base:0,//#MSA-31
        ...
        calculaMontoPago:function(){
            ...
            if (this.liquido_base != 0 && (this.Cmp.tipo.getValue()=='pagado' || this.Cmp.tipo.getValue()=='pagado_rrhh')){//--#MSA-31
                if ( liquido > this.liquido_base){

                    alert('No debe sobrepasar el liquido de ' + this.liquido_base);

                    this.Cmp.liquido_pagable.setValue(this.liquido_base);
                    this.Cmp.descuento_anticipo.setValue(this.desc_anticipo_base);
                    this.Cmp.monto.setValue(this.monto_base);
                }else {
                ...
                this.monto_base = this.Cmp.monto.getValue();
                this.Cmp.liquido_pagable.setValue(liquido>0?liquido:0);
            };
