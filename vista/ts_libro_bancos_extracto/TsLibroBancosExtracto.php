...
?>
<script>
    Phx.vista.TsLibroBancosExtracto=Ext.extend(Phx.gridInterfaz,{

        constructor:function(config){
            this.maestro=config.maestro;
            //llama al constructor de la clase padre
            Phx.vista.TsLibroBancosExtracto.superclass.constructor.call(this,config);
            this.init();
        ...
        tam_pag:50,
        title:'Depósitos',
        ActSave:'../../sis_tesoreria/control/TsLibroBancosExtracto/insertarTsLibroBancosExtracto',
        ActDel:'../../sis_tesoreria/control/TsLibroBancosExtracto/eliminarTsLibroBancosExtracto',
        ActList:'../../sis_tesoreria/control/TsLibroBancosExtracto/listarTsLibroBancosExtracto',
        ...
        loadValoresIniciales:function(){
            Phx.vista.TsLibroBancosExtracto.superclass.loadValoresIniciales.call(this);
            this.cmpIdCuentaBancaria.setValue(this.maestro.id_cuenta_bancaria);
        },

        onButtonNew:function(){
            Phx.vista.TsLibroBancosExtracto.superclass.onButtonNew.call(this);
        ...
        preparaMenu:function(n){
            ...
            Phx.vista.TsLibroBancosExtracto.superclass.preparaMenu.call(this,n);
        ...
        onButtonEdit:function(){
            Phx.vista.TsLibroBancosExtracto.superclass.onButtonEdit.call(this);
        ...
        antEstado:function(res,eve)
        {
            ...
            Ext.Ajax.request({
                url:'../../sis_tesoreria/control/TsLibroBancosExtracto/anteriorEstadoLibroBancos',
        ...
        enviarNotificacion:function(res,eve)
        {
            ...
            Ext.Ajax.request({
                url:'../../sis_tesoreria/control/TsLibroBancosExtracto/enviarNotificacion',
                params:{id_libro_bancos:d.id_libro_bancos,
                    operacion: 'notificar'},
                success:this.successSinc,
                failure: this.conexionFailure,
        ...
        onSaveWizard:function(wizard,resp){
            ...
            Ext.Ajax.request({
                url:'../../sis_tesoreria/control/TsLibroBancosExtracto/siguienteEstadoLibroBancos',
                params:{
        ...
        imprimirCheque : function(){
            ...
            if(NumSelect!=0)
            {
                if(confirm('¿Está seguro de imprimir el cheque?'))
                {
                    ...
                    Phx.CP.loadingShow();
                    Ext.Ajax.request({
                        url:'../../sis_tesoreria/control/TsLibroBancosExtracto/imprimirCheque',
                        params:{
        ...
        imprimirCheque2 : function(){
            ...
            if(NumSelect!=0)
            {
                if(confirm('¿Está seguro de imprimir el cheque?'))
                {
                    ...
                    Phx.CP.loadingShow();
                    Ext.Ajax.request({
                        url:'../../sis_tesoreria/control/TsLibroBancosExtracto/imprimirCheque2',
                        params:{
                            'a_favor':data.a_favor ,
                            'importe_cheque' : data.importe_cheque ,
                            'fecha_cheque_literal' : data.fecha_cheque_literal,
        ...
        vistaPrevia : function(){
            ...
            if(NumSelect!=0)
            {
                ...
                Phx.CP.loadingShow();
                Ext.Ajax.request({
                    url:'../../sis_tesoreria/control/TsLibroBancosExtracto/vistaPrevia',
                    params:{
                        'a_favor':data.a_favor ,
                        'importe_cheque' : data.importe_cheque ,
                        'fecha_cheque_literal' : data.fecha_cheque_literal,
        ...
        iniciarEventos:function(){
            ...
            this.cmpNroCheque.on('focus',function(componente){
                ...
                Ext.Ajax.request({
                    url:'../../sis_tesoreria/control/TsLibroBancosExtracto/listarTsLibroBancos',
