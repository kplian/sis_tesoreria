...
Phx.vista.CajaVb = {
    ...
    constructor: function(config) {
       ...
       this.Atributos[this.getIndAtributo('codigo')].grid=false; 
       this.Atributos[this.getIndAtributo('nro_tramite')].form=false; 
       this.Atributos[this.getIndAtributo('id_depto')].form=false; 
       this.Atributos[this.getIndAtributo('tipo')].form=false; 
       this.Atributos[this.getIndAtributo('tipo_ejecucion')].form=false; 
